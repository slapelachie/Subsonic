 ...
 */
package xyz.slapelachie.supersonic.provider;
...
import xyz.slapelachie.supersonic.service.DownloadServiceLifecycleSupport;
...
public class DSubWidgetProvider extends AppWidgetProvider {
     ...
     *
     * @param playerActive @param playerActive True if player is active in background.  Launch {@link xyz.slapelachie.supersonic.activity.SubsonicFragmentActivity}.
     */
