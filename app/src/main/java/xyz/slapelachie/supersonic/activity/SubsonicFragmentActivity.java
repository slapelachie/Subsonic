 ...
 */
package xyz.slapelachie.supersonic.activity;
...
import xyz.slapelachie.supersonic.domain.PlayerQueue;
import xyz.slapelachie.supersonic.domain.PlayerState;
import xyz.slapelachie.supersonic.domain.ServerInfo;
import xyz.slapelachie.supersonic.fragments.AdminFragment;
import xyz.slapelachie.supersonic.fragments.ChatFragment;
import xyz.slapelachie.supersonic.fragments.DownloadFragment;
import xyz.slapelachie.supersonic.fragments.MainFragment;
import xyz.slapelachie.supersonic.fragments.NowPlayingFragment;
import xyz.slapelachie.supersonic.fragments.SearchFragment;
import xyz.slapelachie.supersonic.fragments.SelectArtistFragment;
import xyz.slapelachie.supersonic.fragments.SelectBookmarkFragment;
import xyz.slapelachie.supersonic.fragments.SelectDirectoryFragment;
import xyz.slapelachie.supersonic.fragments.SelectInternetRadioStationFragment;
import xyz.slapelachie.supersonic.fragments.SelectPlaylistFragment;
import xyz.slapelachie.supersonic.fragments.SelectPodcastsFragment;
import xyz.slapelachie.supersonic.fragments.SelectShareFragment;
...
import xyz.slapelachie.supersonic.updates.Updater;
...
import xyz.slapelachie.supersonic.util.UserUtil;
import xyz.slapelachie.supersonic.util.Util;
import xyz.slapelachie.supersonic.view.ChangeLog;
import xyz.slapelachie.supersonic.view.PlaylistView;
...
public class SubsonicFragmentActivity extends SubsonicActivity implements DownloadService.OnSongChangedListener {
    ...
    public void onBackPressed() {
        if (slideUpPanel.getPanelState() == SlidingUpPanelLayout.PanelState.EXPANDED && nowPlayingFragment.shouldHideNowPlaying()) {
            nowPlayingFragment.hideNowPlaying();
        } else {
