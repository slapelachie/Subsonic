...
import xyz.slapelachie.supersonic.activity.SettingsActivity;
...
public final class ThemeUtil {
    ...
    public static final String THEME_TAKO = "tako";
    ...
    public static int getThemeRes(Context context, String theme) {
        if (context instanceof SubsonicFragmentActivity || context instanceof SettingsActivity) {
            if (Util.getPreferences(context).getBoolean(Constants.PREFERENCES_KEY_COLOR_ACTION_BAR, true)) {
                ...
                } else if (THEME_TAKO.equals(theme)) {
                    return R.style.Theme_Supersonic_Tako_No_Actionbar;
                } else {
                ...
                if (THEME_DARK.equals(theme)) {
                    ...
                    return R.style.Theme_Supersonic_Tako_No_Color;
                } else {
            ...
            if (THEME_DARK.equals(theme)) {
                ...
                return R.style.Theme_Supersonic_Tako;
            } else {
